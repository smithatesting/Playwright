...
export declare class JQL {
    ...
    getPrecomputations<T = Models.JqlFunctionPrecomputationPage>(parameters: Parameters.GetPrecomputations | undefined, callback: Callback<T>): Promise<void>;
    getPrecomputations<T = Models.JqlFunctionPrecomputationPage>(parameters?: Parameters.GetPrecomputations, callback?: never): Promise<T>;
    updatePrecomputations<T = unknown>(parameters: Parameters.UpdatePrecomputations, callback: Callback<T>): Promise<void>;
    updatePrecomputations<T = unknown>(parameters: Parameters.UpdatePrecomputations, callback?: never): Promise<T>;
}
