...
export declare class IssueCustomFieldOptions {
     ...
     */
    getOptionsForField<T = Models.PageCustomFieldOptionDetails>(parameters: Parameters.GetOptionsForField | string, callback: Callback<T>): Promise<void>;
    /**
     * @deprecated This operation is deprecated and becomes unavailable on 8 May 2021. Use [Get custom field options
     *   (context)](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-custom-field-options/#api-rest-api-3-field-fieldid-context-contextid-option-get)
     *   instead. See [Deprecation of custom field
     ...
     *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getOptionsForField<T = Models.PageCustomFieldOptionDetails>(parameters: Parameters.GetOptionsForField | string, callback?: never): Promise<T>;
    /**
