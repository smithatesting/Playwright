...
export declare class SecurityInformation {
     ...
     */
    getLinkedWorkspaces<T = Models.LinkedSecurityWorkspaceIds>(callback: Callback<T>): Promise<void>;
    /**
     * Retrieve all Security Workspaces linked with the Jira site.
     *
     * The result will be what is currently stored, ignoring any pending updates or deletes.
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getLinkedWorkspaces<T = Models.LinkedSecurityWorkspaceIds>(callback?: never): Promise<T>;
    /**
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getLinkedWorkspaceById<T = Models.LinkedWorkspace>(parameters: Parameters.GetLinkedWorkspaceById, callback: Callback<T>): Promise<void>;
    /**
     * Retrieve a specific Security Workspace linked to the Jira site for the given workspace ID.
     *
     * The result will be what is currently stored, ignoring any pending updates or deletes.
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getLinkedWorkspaceById<T = Models.LinkedWorkspace>(parameters: Parameters.GetLinkedWorkspaceById, callback?: never): Promise<T>;
    /**
     ...
     * requires the 'WRITE' scope for Connect apps.
     */
    submitVulnerabilities<T = Models.SubmittedVulnerabilitiesResult>(parameters: Parameters.SubmitVulnerabilities, callback: Callback<T>): Promise<void>;
    /**
     * Update / Insert Vulnerability data.
     *
     * Vulnerabilities are identified by their ID, any existing Vulnerability data with the same ID will be replaced if it
     ...
     * requires the 'WRITE' scope for Connect apps.
     */
    submitVulnerabilities<T = Models.SubmittedVulnerabilitiesResult>(parameters: Parameters.SubmitVulnerabilities, callback?: never): Promise<T>;
    /**
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getVulnerabilityById<T = Models.Vulnerability>(parameters: Parameters.GetVulnerabilityById, callback: Callback<T>): Promise<void>;
    /**
     * Retrieve the currently stored Vulnerability data for the given ID.
     *
     * The result will be what is currently stored, ignoring any pending updates or deletes.
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getVulnerabilityById<T = Models.Vulnerability>(parameters: Parameters.GetVulnerabilityById, callback?: never): Promise<T>;
    /**
