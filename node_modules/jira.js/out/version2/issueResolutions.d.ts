...
export declare class IssueResolutions {
     ...
     *   Permission to access Jira.
     */
    getResolution<T = Models.Resolution>(parameters: Parameters.GetResolution | string, callback: Callback<T>): Promise<void>;
    /**
     * @deprecated Returns an issue resolution value.
     *
     *   **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     *   Permission to access Jira.
     */
    getResolution<T = Models.Resolution>(parameters: Parameters.GetResolution | string, callback?: never): Promise<T>;
    /**
