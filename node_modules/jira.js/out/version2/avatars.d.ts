...
export declare class Avatars {
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** None.
     */
    getAvatarImageByType<T = unknown>(parameters: Parameters.GetAvatarImageByType | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the default project or issue type avatar image.
     *
     * This operation can be accessed anonymously.
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** None.
     */
    getAvatarImageByType<T = unknown>(parameters: Parameters.GetAvatarImageByType | string, callback?: never): Promise<T>;
    /**
